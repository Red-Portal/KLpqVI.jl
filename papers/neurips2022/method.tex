...
Instead of selecting a single \(\vz_t\) by resampling over the \(N\) internal proposals, they suggest reusing the resampling weights to form an importance-weighted estimate.
The theoretical properties of this estimator have been concurrently analyzed by~\citet{cardoso_brsnis_2022} under the name of bias reduced self-normalized importance sampling (BR-SNIS).
