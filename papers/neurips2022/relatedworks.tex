...
In contrast, pMCSA is less affected by model misspecification since, under stationarity, the variance of the Markov chain states is equal to the variance of the posterior.
