...
\begin{table*}
  ...
  \begin{tabular}{lrrrccccc}
    \toprule
    & \multicolumn{1}{c}{\multirow{2}{*}{\footnotesize\(\mathrm{dim}\left(\mathcal{\Lambda}\right)\)}} & \multicolumn{1}{c}{\multirow{2}{*}{\(D\)}} &  \multicolumn{1}{c}{\multirow{2}{*}{\(N_{\text{train}}\)}} & \multicolumn{1}{c}{\multirow{1}{*}{ELBO}} & \multicolumn{4}{c}{MCSA Variants} \\\cmidrule(lr){5-5}\cmidrule(lr){6-9}
   & & & & \(N=1\) & \multicolumn{1}{c}{\multirow{1}{*}{\textbf{pMCSA}}} & \multicolumn{1}{c}{\multirow{1}{*}{JSA}} & \multicolumn{1}{c}{\multirow{1}{*}{CIS}} & \multicolumn{1}{c}{\multirow{1}{*}{CIS-RB}}\\
    \midrule
