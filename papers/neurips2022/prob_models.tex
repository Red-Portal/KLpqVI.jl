...
\subsection{Robust Gaussian Process Logistic Regression}\label{section:gp_logistic}
...
\begin{align*}
   ...
   f   &\sim \mathcal{GP}\left(\mathbf{0}, \mSigma_{\sigma_f^2, \mathbf{\ell}} + \left(\delta + \epsilon\right)\,\mI \right) \\
   \nu &\sim \mathrm{Gamma}\left(\alpha=4, \beta=0.1\right) \\
