...
\begin{theoremEnd}{theorem}\label{thm:msc}
  ...
  {\small
  \V{ \rvvg_{\text{MSC}} \,\middle|\, \mathcal{F}_{t-1} } \leq  L^2,
  }
  \end{align*}
  }
...
\begin{proofEnd}
  ...
  That is,
  \begin{align*}
    \rvvz \mid \rvvz_{t-1}, \rvvlambda_{t-1} &\sim K_{\rvvlambda_{t-1}}\left(\rvvz_{t-1}, \cdot\right)
    \\
    \rvvg_{\text{MSC}} &= \vs\left(\vlambda, \rvvz\right),
  \end{align*}
  ...
  Then,
  \begin{alignat}{2}
    &\V{ \rvvg_{\text{MSC}} \,\middle|\, \mathcal{F}_{t-1} }
    \nonumber
    \\
    &\;\leq
    \E{ \norm{ \rvvg_{\text{MSC}} }^2 \,\middle|\, \mathcal{F}_{t-1}}
    \nonumber
    \\
    &\;=
    \Esub{\rvvz \sim K_{\rvvlambda_{t-1}}\left(\rvvz_{t-1}, \cdot\right)}{
      \norm{ \vs\left(\vlambda; \rvvz\right) }^2 \,\middle|\,
    ...
    \norm{ \vs\left(\vlambda; \vz^{(n)}\right) }^2
    \prod^{N}_{n=2}
