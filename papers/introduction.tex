...
We also show that, under specific conditions, the performance of CIS kernel worsens with the number of proposals (or computational budget) used in each Markov-chain transition.
