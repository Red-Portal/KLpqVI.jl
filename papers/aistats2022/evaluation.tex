...
\begin{enumerate}[noitemsep]
  ...
  \item[\ding{185}] \textbf{single-CISRB}: Score climbing with the single state estimator and the CIS kernel, but also Rao-Blackwellization~\citep{NEURIPS2020_b2070693}.
...
\begin{figure}[H]
  ...
  \subfloat[Test Accuracy]{
    \includegraphics[scale=0.95]{figures/german_02.pdf}
  }  \\
  ...
  %% }
  \subfloat[Test LPD]{
    \includegraphics[scale=0.95]{figures/german_03.pdf}
  }
