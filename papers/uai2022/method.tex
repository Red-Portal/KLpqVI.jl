...
\begin{enumerate}[noitemsep]
  ...
  %\item[\ding{184}] Empirical conjecture that the low variance enables VI to converge faster, leading to a faster decrease of bias.
  \item[\ding{184}] %% Even if we compare the bias of the parallel and sequential state estimator with fixed a \(q_{\vlambda}\),
