...
\vspace{-0.05in}
\subsection{Motivating Example}\label{section:motivation}
\vspace{-0.05in}
...
Combined with~\cref{thm:kl_bound}, our bound suggests that, when the KL is large, the bias could actually \textit{increase} with \(N\).
